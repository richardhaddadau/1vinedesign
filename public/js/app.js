...
let paintLogo = () => {
    ...
    for (let i = 0; i < document.querySelectorAll(".section").length; i++) {
        ...
        if (
            currentSectionTop < elLogoTop &&
            currentSectionBottom > elLogoBottom
        ) {
            if (currentSection.classList.contains("make-light")) {
                document
                    .querySelector(".brand .logo")
                    .classList.add("make-dark");
                document
                    .querySelector(".brand .logo")
                    .classList.remove("make-light");
            } else {
                document
                    .querySelector(".brand .logo")
                    .classList.remove("make-dark");
                document
                    .querySelector(".brand .logo")
                    .classList.add("make-light");
            }
        }
    }
};
...
let paintBackToTop = () => {
    ...
    for (let i = 0; i < document.querySelectorAll(".section").length; i++) {
        ...
        if (
            currentSectionTop < elBackTop &&
            currentSectionBottom > elBackBottom
        ) {
            if (currentSection.classList.contains("make-light")) {
...
let sectionInFocus = (sectionType) => {
    ...
    for (let i = 0; i < document.querySelectorAll(sectionType).length; i++) {
        ...
        if (
            currentSectionBottom < windowTop ||
            currentSectionTop > windowBottom
        ) {
            // Skip Section
            continue;
        } else {
            areaTop =
                currentSectionTop > windowTop ? currentSectionTop : windowTop;
            areaBottom =
                currentSectionBottom < windowBottom
    ...
    if (document.querySelectorAll(".section").length > 1) {
        if (
            document
                ...
                [sectionInFocus(".section")].classList.contains("theme-green")
        ) {
            ...
            for (
                let i = 0;
                i < document.querySelectorAll(".make-light").length;
                i++
            ) {
                document
                    .querySelectorAll(".make-light")
                    [i].classList.remove("vine-orange");
                document
                    .querySelectorAll(".make-light")
                    [i].classList.add("vine-green");
            }
        } else if (
            document
                .querySelectorAll(".section")
                [sectionInFocus(".section")].classList.contains("theme-orange")
        ) {
            // document.documentElement.style.setProperty('--main-theme-color', '#212121');
            document.documentElement.style.setProperty(
                "--main-theme-color",
            ...
            for (
                ...
                document
                    .querySelectorAll(".make-light")
                    [i].classList.remove("vine-green");
                document
                    .querySelectorAll(".make-light")
                    [i].classList.add("vine-orange");
            }
        }
    }
};
...
let randomTestimonial = () => {
    if (document.querySelector(".testimonials-item") == null) {
        ...
        document
            ...
            [randomNo].classList.add("enter-right");
        document
            .querySelectorAll(".testimonials-item")
            [randomNo].classList.add("active");
    }
};
...
setInterval(function () {
    ...
    if (document.querySelector(".testimonials-item") == null) {
        ...
        for (
            let i = 0;
            i < document.querySelectorAll(".testimonials-item").length;
            i++
        ) {
            if (
                document
                ...
                if (
                    i ==
                    document.querySelectorAll(".testimonials-item").length - 1
                ) {
                    j = 0;
                } else {
                    j = i + 1;
        ...
        document
            .querySelectorAll(".testimonials-item")
            [x].classList.remove("enter-right");
        document
            .querySelectorAll(".testimonials-item")
            [x].classList.add("leave-left");
        ...
        setTimeout(() => {
            ...
            document
                .querySelectorAll(".testimonials-item")
                [j].classList.remove("leave-left");
            document
                .querySelectorAll(".testimonials-item")
                [j].classList.add("active");
            document
                .querySelectorAll(".testimonials-item")
                [j].classList.add("enter-right");
        }, 800);
    }
}, 10000);
...
if (document.querySelector("form.make-contact")) {
    document
        .querySelector("form.make-contact")
        .addEventListener("submit", function (e) {
            document.querySelector(
                ".make-contact .btn-submit span.default"
            ).style.display = "none";
            document.querySelector(
                ".make-contact .btn-submit span.loading"
            ).style.display = "block";
            // e.preventDefault();
        });

    document
        .querySelectorAll("form.make-contact input[type=email]")
        .forEach((item) => {
    ...
    document
        .querySelectorAll("form.make-contact input[type=text]")
        .forEach((item) => {
            item.addEventListener("keyup", function (e) {
    ...
    document
        .querySelectorAll("form.make-contact input[type=tel]")
        .forEach((item) => {
            item.addEventListener("keyup", function (e) {
...
let deliver = (deliverable) => {
    ...
    if (
        document
            .querySelector(".deliverables-collection")
            .classList.contains("hinged")
    ) {
        deliverableTop =
            document.querySelectorAll(".package-card")[deliverable]
                .parentElement.offsetTop +
            document.querySelectorAll(".package-card")[deliverable].offsetTop -
            100;
    } else {
        deliverableTop =
            document.querySelectorAll(".package-card")[deliverable]
...
let flipBack = (e) => {
    ...
    if (e.target.classList.contains("package-card")) {
        ...
        e.target.parentElement.parentElement.classList.contains("package-close")
    ) {
        packageCard =
            e.target.parentElement.parentElement.parentElement.parentElement
                .parentElement;
...
let ToggleReference = (e) => {
    ...
    let siblingElement = document.querySelector(
        ".package-reference[data-package-data='" +
            e.target.dataset.packageSource +
            "']"
    );
...
window.addEventListener("load", function () {
    ...
    document.getElementById("footer-copyright").innerHTML =
        "Copyright © " + thisYear + " 1VINE Design. All rights reserved.";
    ...
    if (document.querySelectorAll(".deliverables-collection").length > 0) {
        let deliverablesCollection = document.querySelector(
...
if (document.getElementById("quote_select") !== null) {
    document
        .getElementById("quote_select")
        .addEventListener("change", function (e) {
            if (e.target.value !== 0) {
                document
                    .querySelector(".quote-select-wrapper")
                    .classList.add("make-chosen");
                document
                    .querySelector(".quote-select-wrapper")
                    .classList.remove("make-default");
            }
        });
}
