          ...
          <tr>
            <td bgcolor="#FFFFFF" style="border-top-left-radius:4px; border-top-right-radius:4px;" align="center">
              <table align="center" width="90%" border="0" cellspacing="0" cellpadding="0">
                ...
                <!-- title -->
                <tr>
                  <td align="center" style="font-family: 'Open Sans', Arial, sans-serif; font-size:36px; color:#3b3b3b; font-weight: bold; letter-spacing:4px;">You have a new project!</td>
                </tr>
                <!-- end title -->
                <!-- dash -->
                <tr>
                ...
                <tr>
                  <td align="center" style="font-family: 'Open Sans', Arial, sans-serif; font-size:13px; color:#7f8c8d; line-height:30px;">
                    <p>Package</p>
                    <p><strong>{{ $newQuote->package }}</strong></p>
                    <p>Name</p>
                    <p><strong>{{ $newQuote->name }}</strong></p>
                    <p>Company / Organisation</p>
                    <p><strong>{{ $newQuote->business }}</strong></p>
                    <p>Email</p>
                    <p><strong>{{ $newQuote->email }}</strong></p>
                    <p>Phone</p>
                    <p><strong>{{ $newQuote->tel }}</strong></p>
                    <p>Mobile</p>
                    <p><strong>{{ $newQuote->mobile }}</strong></p>
                    <p>Message</p>
                    <p><strong>{{ $newQuote->project }}</strong></p>
                    <p>ReCaptcha Score</p>
                    <p><strong>{{ $newQuote->score }}</strong></p>
                  </td>
                </tr>
                <tr>
                  <td height="45"></td>
