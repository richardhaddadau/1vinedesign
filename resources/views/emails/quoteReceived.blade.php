    ...
    <tr>
      <td background="{{ asset('img/email/bg.jpg') }}" bgcolor="#494c50" valign="top" style="background-size: cover; background-position: center;">
        <table align="center" width="600" class="table-inner" style="max-width: 600px;" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td bgcolor="#FFFFFF" style="border-top-left-radius:4px; border-top-right-radius:4px;" align="center">
              <table align="center" width="90%" border="0" cellspacing="0" cellpadding="0">
                ...
                <!-- title -->
                <tr>
                  <td align="center" style="font-family: 'Open Sans', Arial, sans-serif; font-size:36px; color:#3b3b3b; font-weight: bold; letter-spacing:4px;">Quote Request Received!</td>
                </tr>
                <!-- end title -->
                <!-- dash -->
                <tr>
                ...
                <tr>
                  <td align="center" style="font-family: 'Open Sans', Arial, sans-serif; font-size:13px; color:#7f8c8d; line-height:30px;">
                    Thank you for considering 1VINE Design for your next project. I've received your request for a quote.  Please give me some time to read through the details you sent through and I'll get back to you as soon as possible.<br><br>In the meantime, why not check out more of my work?
                  </td>
                </tr>
                <!-- end content -->
                <tr>
                ...
                <tr>
                  <td align="center">
                    <table class="textbutton" align="center" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td class="btn-link" bgcolor="#7db241" height="55" align="center" style="font-family: 'Open Sans', Arial, sans-serif; font-size:18px; color:#FFFFFF; font-weight: bold;padding-left: 25px;padding-right: 25px;border-radius:30px;">
                          <a href="https://1vinedesign.com.au/work-portfolio">1VINE Work Portfolio</a>
                        </td>
                      </tr>
                    </table>
                  </td>
          ...
          <!-- copyright -->
          <tr>
            <td align="center" style="font-family: 'Open Sans', Arial, sans-serif; font-size:13px; color:#FFFFFF;">© 2021 1VINE Design. All Rights Reserved.</td>
          </tr>
          <!-- end copyright -->
          <tr>
            <td height="30"></td>
